...
/**
 * Standalone price calculator — same tier/plan/slot/meal-type selection and pricing
 * logic as Step1Tierplan.jsx, but with no location check, waitlist, or login gate,
 * since anyone should be able to explore prices before committing to sign up. The
 * "Subscribe now" CTA hands off to the real checkout flow at /subscribe, where the
 * customer re-selects (location check + auth live there, not here).
 */
export default function PriceCalculator() {
  ...
  const canSubscribe = !!(tier && plan && slotChoice && mealType && pricing);

  return (
    <div>
      <SEO
        title="Price Calculator | Macra"
        description="See exactly what your Macra subscription will cost — pick a bowl tier, plan, delivery time, and meal type. No sign-up needed to check."
      ...
      >
        <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <div className="text-center">
            <p className="text-xs font-semibold uppercase tracking-wider text-emerald-dark sm:text-sm">
              Price calculator
            </p>
            <h1 className="mt-2 font-heading text-2xl font-bold text-forest sm:text-3xl">
              See exactly what you'll pay.
            </h1>
            <p className="mx-auto mt-2 max-w-md text-sm text-text-muted sm:text-base">
              Pick a tier, plan, and schedule — no sign-up needed to check the price.
            </p>
          </div>
            ...
            {loading ? (
              ...
              <div className="space-y-7">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-full py-4 font-heading text-sm font-semibold text-white shadow-md transition-all duration-200 hover:scale-[1.01] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40"
                  style={{
